...
Remember to replace the `config` variable in your `src/firebase/firebaseConfig.js` with your own config object from the firebase dashboard! Navigate to the project settings and scroll down to the config code. Copy the object in the code and replace the variable in your cloned code.

![alt text](https://i.ibb.co/6ywMkBf/Screen-Shot-2019-07-01-at-11-35-02-AM.png 'image to firebase config')

## Set your stripe publishable key

Set the `publishableKey` variable in the `src/components/stripe-button/stripe-button.component.jsx` with your own publishable key from the stripe dashboard.
